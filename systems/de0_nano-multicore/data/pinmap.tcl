...
#
# UART0: RX <-> GPIO_2[3] (Pin 8, bottom header)
#        TX <-> GPIO_2[6] (Pin 11, bottom header)
#
...
#
# I2C1: sda <-> GPIO_2[1] (Pin 6, bottom header)
#       scl <-> GPIO_2[7] (Pin 12, bottom header)
#
set_location_assignment PIN_B16 -to i2c1_sda_io
...
#       MISO <-> GPIO_2[0] (Pin  5, bottom header)
...
set_location_assignment PIN_A14 -to spi2_miso_i
